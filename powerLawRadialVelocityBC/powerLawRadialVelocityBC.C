...
#include "powerLawRadialVelocityBC.H"
...
powerLawRadialVelocityBC::powerLawRadialVelocityBC
(
    const fvPatch& p,
...
powerLawRadialVelocityBC::powerLawRadialVelocityBC
(
    const powerLawRadialVelocityBC& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
powerLawRadialVelocityBC::powerLawRadialVelocityBC
(
    const powerLawRadialVelocityBC& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
void powerLawRadialVelocityBC::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void powerLawRadialVelocityBC::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, powerLawRadialVelocityBC);
